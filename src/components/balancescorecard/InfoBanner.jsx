    ...
    <div className="rounded-md bg-teal-700 p-4 m-4 text-white">
      <div className="flex">
        ...
        <div className="ml-3 flex-1 md:flex md:justify-between">
          <p className="text-sm">
            This is a friendly reminder that all you need to do on this tab is to update your scores. If you are ready to start your appraisals,{' '}
            <a href="#" className="font-medium whitespace-nowrap underline hover:text-blue-600">
              click here
            </a>. If you want to take a performance review,{' '}
            <a href="#" className="font-medium whitespace-nowrap underline hover:text-blue-600">
              click here
            </a>.
          </p>
