    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          'focus:outline-none',
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:data-[focus]:ring-2 after:data-[focus]:ring-blue-500 dark:after:data-[focus]:ring-white',
          // Disabled state
      ...
      <Headless.ListboxOptions
        ...
        className={clsx(
          ...
          'outline outline-1 outline-transparent focus:outline-none dark:outline-white',
