...
const RegionModal = ({ isOpen, closeModal, onSubmit, initialData = null }) => {
                ...
                <div className="px-6 py-6">
                  {!isEditing && (
                    <div className="mb-4 p-3 bg-blue-50 rounded-md border border-blue-100 flex items-start">
                      ...
                      <p className="text-sm text-blue-700">Create a new region. Optionally assign a regional manager.</p>
                    </div>
                  )}

                  <RegionForm initialData={initialData} onSubmit={onSubmit} onCancel={closeModal} isModal={true} isEditing={isEditing} />
                </div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
