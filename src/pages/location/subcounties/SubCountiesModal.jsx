...
import SubCountiesForm from "./SubCountiesForm";

const SubCountiesModal = ({ isOpen, closeModal, onSubmit, initialData = null }) => {
                ...
                <div className="bg-teal-50 px-6 py-5 border-b border-teal-100">
                  <div className="flex items-center justify-between">
                    <Dialog.Title className="text-lg font-semibold text-gray-800 capitalize">
                      {isEditing ? "Edit Sub-County" : "Create New Sub-County"}
                    </Dialog.Title>
                ...
                <div className="px-6 py-6">
                  {!isEditing && (
                    <div className="mb-4 p-3 bg-blue-50 rounded-md border border-blue-100 flex items-start">
                      ...
                      <p className="text-sm text-blue-700">Create a new sub-county by entering short code, name and selecting county (select district first to narrow counties).</p>
                    </div>
                  )}

                  <SubCountiesForm initialData={initialData} onSubmit={onSubmit} onCancel={closeModal} isModal={true} isEditing={isEditing} />
                </div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
...
export default SubCountiesModal;
