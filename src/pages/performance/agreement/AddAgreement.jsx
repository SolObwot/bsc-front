...
import CreateWeightModal from '../strategyPerspective/CreateWeightModal';


const AddAgreement = ({ isOpen, closeModal, onSubmit, departments = [], perspectives = [], initialData = null }) => {
