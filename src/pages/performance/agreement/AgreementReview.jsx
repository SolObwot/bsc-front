...
const AgreementReview = ({
  ...
  const handleReset = () => {
    ...
    const defaultDept =
      departmentFilter || userDepartmentId || filterDepartment || "";
  ...
  const getDepartmentOptions = () => {
    ...
    if (
      filterDepartment &&
      !options.some((opt) => opt.value === filterDepartment)
    ) {
      const deptName =
        agreements.find(
          (a) => a.department && a.department_id.toString() === filterDepartment
