...
const DeletePerformanceMeasure = ({ isOpen, closeModal, performanceMeasureId, prevObjectives, onDataChange }) => {
  ...
  const { selectedPerformanceMeasure } = useSelector((state) => state.performanceMeasure);
  ...
  // Only show details relevant to the type
  const isQualitative = selectedPerformanceMeasure.type === "qualitative";
  ...
  return (
    ...
    >
      <div className="space-y-6">
            ...
            <div className="overflow-hidden border border-gray-200 rounded-lg">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {(selectedPerformanceMeasure.qualitative_levels && selectedPerformanceMeasure.qualitative_levels.length > 0) ? (
                    selectedPerformanceMeasure.qualitative_levels.map((level) => (
        ...
        {/* Only show Performance Levels Guide for quantitative */}
        {!isQualitative && (
          <div className="mt-6">
            ...
            <div className="overflow-hidden border border-gray-200 rounded-lg">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {getPerformanceLevels(selectedPerformanceMeasure).map((level) => (
