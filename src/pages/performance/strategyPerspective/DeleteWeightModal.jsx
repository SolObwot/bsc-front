...
const DeleteWeightModal = ({ isOpen, closeModal, onConfirm, weight }) => {
  return (
                ...
                <div className="bg-red-50 px-6 py-5 border-b border-red-100">
                  <div className="flex items-center justify-between">
                    <Dialog.Title className="text-lg font-semibold text-gray-800">
                      Delete Strategy Perspective Weight
                    </Dialog.Title>
                ...
                <div className="px-6 py-6">
                  <div className="space-y-4">
                    <p className="text-gray-700">
                      Are you sure you want to delete this strategy perspective weight?
                    </p>
                    ...
                    <div className="bg-gray-50 p-3 rounded-md text-sm text-gray-600">
                      ...
                      <p>Perspective: {weight?.perspective?.name || 'Unknown'}</p>
                      <p>Department: {weight?.department_name || 'Unknown'}</p>
                      <p>Weight: {weight?.weight || 0}%</p>
                      <p>Status: {weight?.status || 'Unknown'}</p>
                    </div>
                  </div>
