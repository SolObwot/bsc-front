  ...
  return (
    <div className="min-h-screen bg-white shadow-md rounded-lg">
      ...
      <div className="flex justify-between p-4 bg-gray-100">
        <div>
          <h1 className="text-xl font-bold text-gray-800">Edit Strategy Perspective</h1>
          <p className="text-sm text-gray-600 mt-1">
            Modify existing strategy perspective
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center p-12 text-center">
        <div className="max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            The ability to edit strategy perspective with ID: {id} is currently being developed.
