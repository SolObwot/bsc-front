...
import UnitOrBranchForm from './UnitOrBranchForm';

const UnitOrBranchModal = ({
    isOpen,
    closeModal,
    onSubmit,
    initialData = null,
                                ...
                                <div className="bg-teal-50 px-6 py-5 border-b border-teal-100">
                                    <div className="flex items-center justify-between">
                                        <Dialog.Title className="text-lg font-semibold text-gray-800 capitalize">
                                            {isEditing ? "Edit Unit/Branch" : "Create New Unit/Branch"}
                                        </Dialog.Title>
                                    ...
                                    {!isEditing && (
                                        <div className="mb-4 p-3 bg-blue-50 rounded-md border border-blue-100 flex items-start">
                                            ...
                                            <p className="text-sm text-blue-700">
                                                Create a new unit or branch by entering a short code, name, type, and other details.
                                            </p>
                                        </div>
                                    )}
...
export default UnitOrBranchModal;
