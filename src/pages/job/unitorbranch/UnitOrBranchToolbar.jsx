...
const UnitOrBranchToolbar = ({ onAddUnitOrBranch, recordsPerPage, onRecordsPerPageChange, totalRecords }) => {
    return (
...
export default UnitOrBranchToolbar;
